    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
          ...
          echo '<td><select name="'.$row['id'].'_category">
                      <option value="MainCourse"'.($row['category']=='MainCourse' ? 'selected' : '').'>Main Course</option>
                      <option value="Appetizer"'.($row['category']=='Appetizer' ? 'selected' : '').'>Appetizer</option>
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Item Price/Piece</th>
